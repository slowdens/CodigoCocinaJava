 ...
 * @author neftaly
 */
@WebServlet(urlPatterns = {"/Textura"})
public class Textura extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(permiso.equals("Si")&& rol.equals("Administrador"))
            {
                ...
                + "         <script src=\"script/customisado/textura.js\"></script>"
                ...
                + "         <!--Iniciamos modales html-->"
                + "         <div class=\"modal fade\" id=\"modalAgregar\">\n" 
                + "         <div class=\"modal-dialog\">\n" 
                + "            <div class=\"modal-content\">\n" 
                + "                <div class=\"modal-header\">\n" 
                + "                  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n" 
                + "                  <h4 class=\"modal-title text-center\">Agregar Textura</h4>\n" 
                + "                </div>\n" 
                ...
                + "                            </div>\n" 
                + "                            <div class=\"col-md-3\">\n"
                + "                                <input type=\"text\" id=\"txtTextura\" class=\"form-control validate[required]\" />                                \n" 
                + "                            </div>\n" 
                + "                        </div>    \n" 
                + "                        <div class=\"row\">\n"
                + "                            <div class=\"col-md-2\">\n" 
               ...
               //Modal para meter informacion de actualizar 
