 ...
 * @author neftaly
 */
@WebServlet(name = "ActualizarCubierta", urlPatterns = {"/ActualizarCubierta"})
public class ActualizarCubierta extends HttpServlet {
           ...
           String precio=null, textura=null,nombreImagen=null,urlCompleta=null,id=null;
            ...
            try{ 
                ...
                while ( i.hasNext () ) 
                {
                    ...
                    if(count==3)
                    {
                        query="{CALL sp_actualizar_cubierta('"+textura+"',"+precio+",'"+completa+"',"+id+")}";
