 ...
 * @author neftaly
 */
@WebServlet(name = "AgregarDetalleProducto", urlPatterns = {"/AgregarDetalleProducto"})
public class AgregarDetalleProducto extends HttpServlet {
   ...
   private ResultSet rs ;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String modelo=null, color=null,nombreImagen=null,urlCompleta=null,material=null,producto=null,textura=null,cubierta=null,tamanio=null;
            ...
            try{
                ...
                while ( i.hasNext () ) 
                {
                    ...
                    if(count==7)
                    {
                        query="{CALL sp_agrega_productoDetalle('"+modelo+"','"+color+"','"+material+"',"+producto+","+textura+","+cubierta+",'"+tamanio+"','"+completa+"')}";
                        rs = db.precedureQuery(query);
                        while (rs.next())
                        {
                            resultado ="{\"valor\":\""+rs.getString(1)+"\",\"liga\":\""+completa+"\",\"ids\":\""+rs.getString(2)+"\",\"Producto\":\""+rs.getString(3)+"\",\"Textura\":\""+rs.getString(4)+"\",\"Cubierta\":\""+rs.getString(4)+"\"}";
                            this.res = resultado;
