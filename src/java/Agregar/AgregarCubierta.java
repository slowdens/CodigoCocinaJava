 ...
 * @author neftaly
 */
@WebServlet(name = "AgregarCubierta", urlPatterns = {"/AgregarCubierta"})
public class AgregarCubierta extends HttpServlet {
   ...
   private String filePath="/home/neftaly/NetBeansProjects/Conycom/web/imagenes/Cubiertas/",res=null;
   ...
   private ResultSet rs ;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String precio=null, cubierta=null,nombreImagen=null,urlCompleta=null;
            ...
            factory.setRepository(new File("/home/neftaly/NetBeansProjects/Conycom/web/imagenes/Cubiertas"));
            ...
            try{ 
                ...
                while ( i.hasNext () ) 
                {
                    ...
                    if(count==2)
                    {
                        query="{CALL sp_agrega_cubierta('"+cubierta+"',"+precio+",'"+completa+"')}";
