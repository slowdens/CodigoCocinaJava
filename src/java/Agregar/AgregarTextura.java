 ...
 * @author neftaly
 */
@WebServlet(name = "AgregarTextura", urlPatterns = {"/AgregarTextura"})
public class AgregarTextura extends HttpServlet {
   ...
   private ResultSet rs ;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String precio=null, textura=null,nombreImagen=null,urlCompleta=null;
            ...
            try{ 
                ...
                while ( i.hasNext () ) 
                {
                    ...
                    if(count==2)
                    {
                        query="{CALL sp_agrega_textura('"+textura+"',"+precio+",'"+completa+"')}";
