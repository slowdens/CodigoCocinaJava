    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(permiso.equals("Si")&& rol.equals("Administrador"))
               {
                ...
                + "         <script src=\"script/customisado/venta.js\"></script>"
           ...
           html+="<div class=\"modal fade\" id=\"modalAgregar\">\n" 
               ...
               + "                            </div>\n" 
               + "                            <div class=\"col-md-3\">\n" 
               + "                                <select id=\"sltCliente\" class=\"form-control validate[required] \">\n" 
               + "                                    <option value=\"\">Seleeccione</option>\n" ;
                                    /*Mostramos todos los clientes disponibles*/
                                                        concantenado="";
                                                        query="SELECT id_cliente,usuario FROM usuario WHERE id_rol=2;";
          ...
          html +=concantenado+ "                 </select>                                                                \n" 
               ...
               + "                            </div>\n" 
               + "                            <div class=\"col-md-3\">\n" 
               + "                                <input type=\"text\" id=\"txtMontoTotal\" class=\"form-control validate[required] \" />                                \n" 
               + "                            </div>\n" 
               + "                        </div>                                                                            \n" 
               + "                    </form>              \n" 
               + "                </div>\n" 
               ...
               + "                  <button type=\"button\" class=\"btn btn-primary\" id=\"btnAgregarVenta\">Guardar</button>\n" 
               + "                </div>\n" 
               + "            </div><!-- /.modal-content -->\n" 
               + "        </div><!-- /.modal-dialog -->\n" 
               + "    </div><!-- /.modal -->";
          
                /*Modal para actualizar la lista de datos*/          
             ...
             html+="<div class=\"modal fade\" id=\"modalActualizar\">\n"
               ...
               + "                            </div>\n" 
               + "                            <div class=\"col-md-3\">\n" 
               + "                                <select id=\"sltClienteActualizar\" class=\"form-control validate[required]\">\n" 
             ...
             html  += concantenado+"                                </select>                                                                \n" 
               ...
               + "                            </div>\n" 
               + "                            <div class=\"col-md-3\">\n" 
               + "                                <input type=\"text\" id=\"txtMontoTotalActualizar\" class=\"form-control validate[required]\" />                                \n" 
               + "                            </div>\n" 
               + "                        </div>                                                                            \n" 
               + "                    </form>              \n" 
               + "                </div>\n" 
               + "                <div class=\"modal-footer\">\n" 
               + "                  <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n" 
               + "                  <button type=\"button\" class=\"btn btn-primary\" id=\"btnActualizarVenta\">Guardar</button>\n" 
               + "                </div>\n" 
               + "            </div><!-- /.modal-content -->\n" 
               + "        </div><!-- /.modal-dialog -->\n" 
               + "    </div><!-- /.modal -->";
